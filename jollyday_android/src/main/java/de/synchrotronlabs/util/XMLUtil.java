 ...
 * @version $Id: $
 */
package de.synchrotronlabs.util;
...
import de.synchrotronlabs.config.Month;
import de.synchrotronlabs.config.Weekday;
import de.synchrotronlabs.holidaytype.LocalizedHolidayType;
...
public class XMLUtil {
	 ...
	 * 
	 * @param weekday
	 *            a {@link de.synchrotronlabs.config.Weekday} object.
	 ...
	 * 
	 * @param month
	 *            a {@link de.synchrotronlabs.config.Month} object.
	 * @return DateTimeConstants value.
	 */
	 ...
	 */
	public HolidayType getType(de.synchrotronlabs.config.HolidayType type) {
		switch (type) {
