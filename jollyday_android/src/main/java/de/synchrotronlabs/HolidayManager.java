...
import de.synchrotronlabs.configuration.ConfigurationProviderManager;
...
//		HolidayManager m = null;
//		Set<String> codes = HolidayManager.getSupportedCalendarCodes();
//		for (String s : codes) {
//			m = HolidayManager.getInstance(s);
//			Map<String, CalendarHierarchy> map = m.getCalendarHierarchy().getChildren();
//			for (Map.Entry<String, CalendarHierarchy> h : map.entrySet()) {
//				String sub = h.getKey();
//				System.out.println(s + ";" + sub);
//				System.out.println(m.getHolidays(2016, sub));
//			}
//		}
